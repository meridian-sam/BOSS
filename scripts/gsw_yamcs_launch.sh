...
$DFLAGS -v $BASE_DIR:$BASE_DIR -v /tmp/nos3:/tmp/nos3 -w $BASE_DIR/gsw/yamcs --name yamcs-operator_1 --network=nos3_sc_1 -p 8090:8090 --env-file $BASE_DIR/gsw/yamcs/epsilon3.env maven:3.9.9-eclipse-temurin-17 mvn -Dmaven.repo.local=$BASE_DIR/.m2/repository yamcs:run
